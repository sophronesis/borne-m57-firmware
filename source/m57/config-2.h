...
// ============================================================
// SPLIT MASTER CONFIGURATION (UPDATED)
// ============================================================
...
// ============================================================
// BOOT SEQUENCE DOCUMENTATION (ADDED)
// ============================================================
...
// ============================================================
// RGB MATRIX NOTE (ADDED)
// ============================================================

/*
RGB MATRIX ENABLE NOTE:

RGB matrix functionality depends on rules.mk:
    RGB_MATRIX_ENABLE = yes

Even though info.json includes:
    "rgb_matrix": true

This alone is NOT sufficient.

Always explicitly enable RGB matrix in rules.mk to avoid build issues.
*/
