...
These require fallback mapping.
*/
...
Modes only enable/disable layers.
*/
...
void render_context(uint8_t brightness) {
...
void render_event(uint8_t brightness) {
...
bool rgb_matrix_indicators_user(void) {
    ...
    // ========================================================
    // LAYER 2: CONTEXT (mode-controlled)
    // ========================================================
