...
/*
============================================================
VIAL COMPATIBILITY GUARANTEES
============================================================

1. KEYMAP ACCESS
   - All key lookups must go through get_keycode_at()
   - Direct keymaps[][] access is forbidden

2. RGB SYSTEM
   - Custom pipeline runs ONLY in RGB_MATRIX_CUSTOM mode
   - Prevents conflict with Vial/QMK RGB controls

3. KEYCODE CACHE
   - Cache refreshed:
       - on layer change
       - periodically (runtime safe for Vial)

This ensures:
✔ runtime remapping works
✔ LEDs reflect correct key behavior
✔ no stale or conflicting state occurs
*/


/*
============================================================
VIAL-SAFE KEYMAP ACCESS WRAPPER
============================================================
*/
