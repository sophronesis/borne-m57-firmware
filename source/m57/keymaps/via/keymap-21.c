#include QMK_KEYBOARD_H#include QMK_KEYBOARD "theme.h"
#include "eeconfig.h"
...
/*
Fast check whether LED belongs to OS zone.

Optimized for small fixed-size arrays.
*/
...
bool rgb_matrix_indicators_user(void) {
    ...
    // ✅ improvement: dynamic brightness
